...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new(1, "Emily", "Emily@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new(2, "Maria", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new(3, "Alex", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new(4, "Martha", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new(5, "William", "william@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new(6, "Thomas", "thomas@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
